...
public class ButtonGenerator {
	...
	private JButton closeLights = new JButton("Close Lights");
	...
	public JButton doCloseLights(){
		closeLights.setBounds(250,415,105,20);
		closeLights.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e){
            	try {
					sendCommand.writeCommand("C");
				} catch (SerialPortException e1) {
	...
	public JButton doLowBeamButton(){
		lowBeam.setBounds(250,360,50,50);
		//(110,380,44,55);
		lowBeam.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				try {
					sendCommand.writeCommand("L");
				} catch (SerialPortException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
	...
	public JButton doHighBeamButton(){
		highBeam.setBounds(305,360,50,50);
		highBeam.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				try {
					sendCommand.writeCommand("H");
				} catch (SerialPortException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
